...
void login()
{
	...
	Password[i] = '\0';
    if(strcmp(UserName,"olamide")==0 && strcmp(Password,"1234")==0)
    {
    	system("cls");
    	loginFrame1();
    	gotoXY(27,10);
...
// this is for the border display
...
//THis is for the content inside the border
...
void intro()
{
	gotoXY(24,4); printf("PROJECT NAME: PAYROLL MANAGEMENT SYSTEM");
	gotoXY(24,8); printf("NAME: ADENIYI SEKINAT ASAKUN");
	gotoXY(24,9); printf("MATRIC NUMBER: H/CTE/22/0706");
	gotoXY(24,10); printf("SUPERVISOR NAME: MR NZUBE");
	gotoXY(24,11); printf("SCHOOL: FEDERAL POLYTECHNIC ILARO");
